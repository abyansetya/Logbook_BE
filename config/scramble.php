...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'API untuk sistem Logbook Kerja Sama — mengelola dokumen kerja sama (MoU/MoA/IA), mitra, log aktivitas, user, dan role.',
    ],

    'ui' => [
        'title' => env('API_TITLE', 'Logbook API'),
    ],
